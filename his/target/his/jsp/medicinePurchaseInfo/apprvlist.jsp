        ...
        $(function () { 
            ...
            $("#apprvBtn").click(function () {
                ...
                $(":checked").each(function () {
                    url+="&inputid="+$(this).attr("name")+"&pchId="+$(this).val();
                })
                location.href = url;
            })
        })  
...
<body class="main"> 
    <div class="search"> 
        ...
        <span>
            <button id="apprvBtn">审批购买</button>
        </span>
    </div> 
    <table>
        <thead>
        ...
        <c:forEach items="${list}" var="medicinePurchaseInfo" varStatus="status"> 
            <tr>
                ...
                <td><input type="checkbox" value="${medicinePurchaseInfo.medicineReqPlan.reqplnno}" name="${medicinePurchaseInfo.pchId}"></td>
