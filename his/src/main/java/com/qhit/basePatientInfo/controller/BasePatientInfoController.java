...
public class BasePatientInfoController { 
    ...
    public void ajaxList(HttpServletResponse response,Integer pid) throws IOException {
        List<BasePatientInfo> list = basePatientInfoService.findSAll(pid);
    ...
    public String searchs(BasePatientInfo basePatientInfo,Model model) {
        List<BasePatientInfo> list = basePatientInfoService.search(basePatientInfo);
        model.addAttribute("list",list);
        model.addAttribute("searchObject",basePatientInfo);
