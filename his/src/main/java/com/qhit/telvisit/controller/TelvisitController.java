...
public class TelvisitController { 
    ...
    public String lists(Integer cid,Model model){
        List<Telvisit> list = telvisitService.find(cid);
        model.addAttribute("list",list);
        return "telvisit/list";
    }
    @RequestMapping("/findadd")
    public String findadd(Integer cid,Model model){
        List<Telvisit> list = telvisitService.findAdd(cid);
        model.addAttribute("list",list);
        List<Telvisit> lists = telvisitService.findAll();
