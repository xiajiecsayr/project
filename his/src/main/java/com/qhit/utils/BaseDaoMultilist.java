 ...
 */
public class BaseDaoMultilist {

    //需要生成mapper文件的sql语句
    private static String sql = "SELECT * from study st JOIN site si ON st.s_siteid=si.m_id";
    //主表
    private static String mainTable = "study";
    ...
    public static void main(String[] args) throws IOException {
        //文件输出位置
        File dir = new File("f:\\codeout\\generateMapper.xml");
        //字节输出流
...
//            不是主表
            for (String tableName:tableColumnes.keySet()){
                if(!mainTable.equals(tableName)){
                    ...
                    String packageName = toLowerCaseFirstOne(beanName);/*select="com.qhit.test1.dao.ITest1Dao.findById" column="t_id"*/
                    associationBuffer.append("\t\t<association property=\""+packageName+"\" select=\"com.qhit."+packageName+".dao."+"I"+beanName+"Dao"+".findById\" column=\""+"\"> </association>\r\n");
