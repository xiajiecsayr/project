    ...
    <script type="text/javascript"> 
        $(function () { 
            $("#addBtn").click(function () { 
                location.href="../medicinePurchaseInfo/add.jsp";
             })
            ...
            $("#apprvBtn").click(function () {
                var invno = $("#invno").val();
                if(invno){
                    var url = "${path}/medicineInstock/updateBantch.action?a=a";
                    $(":checked").each(function () {
                            url+="&pchId="+$(this).val()+"&invno="+$("#invno").val();
                    })
                    location.href = url;
                }else {
                    alert("请输入发票号");
