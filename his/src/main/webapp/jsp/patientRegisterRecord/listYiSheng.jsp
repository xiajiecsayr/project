    ...
    <script type="text/javascript"> 
        $(function () { 
            ...
            $(".delete").click(function () { 
                var registerId = $(this).attr("name");
                location.href="${path}/patientRegisterRecord/delete1.action?registerId="+registerId;
             })
    ...
    <table> 
        ...
        <c:forEach items="${list}" var="patientRegisterRecord" varStatus="status"> 
            <tr> 
                ...
                <td>${patientRegisterRecord.cname}</td><%--//医生--%>
                <c:choose>
                    <c:when test="${patientRegisterRecord.status==0}">
                        <td>未挂号</td>
                    </c:when>
                    <c:otherwise>
                        <td>已挂号</td>
