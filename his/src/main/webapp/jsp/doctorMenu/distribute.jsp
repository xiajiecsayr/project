    ...
    <script type="text/javascript">
        $(function(){
            ...
            $(".buttons button:eq(4)").click(function(){
                ...
                location.href = "${path}/doctorMenu/distributeUpdate.action?MenuId=${MenuId}&fid="+fid;
                /*var rids = "";
               $("#right option").each(function () {
                    var $selected = $("#right option");
...
<select multiple="multiple" id="left" >
    <c:forEach items="${leftlist}" var="baseleft">
        <option value="${baseleft.codeId}">${baseleft.medicineName}</option>
    </c:forEach>
...
<select multiple="multiple" id="right" >
    <c:forEach items="${rightlist}" var="baseright">
        <option value="${baseright.codeId}">${baseright.medicineName}</option>
    </c:forEach>
